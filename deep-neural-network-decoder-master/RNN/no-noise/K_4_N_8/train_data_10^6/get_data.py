...
#    for snr in train_snr:
    ...
    sio.savemat('/home/zl/桌面/解码/deep-neural-network-decoder-master/data/' + filename, {'x_train': x_train, 'y_train': y_train})
...
filename = 'test.mat'
sio.savemat('/home/zl/桌面/解码/deep-neural-network-decoder-master/data/'+filename, {'x_test' : x_test, 'y_test' : y_test})
